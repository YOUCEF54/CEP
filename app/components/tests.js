//Post1
"use client"
import {motion,useAnimate,usePresence, useInView} from 'framer-motion'
...
export default function Post({post, index}){
    ...
    return(
        <div key={Post.id} ref={scope} className="p-4 w-[50vw] m-auto rounded-lg bg-slate-50 border flex gap-3">
